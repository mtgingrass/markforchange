...
I want to take a moment to thank you and South Carolina’s leadership for the ongoing efforts to protect, expand, and invest in our state parks... [truncated for brevity]`
        },
        "future_generations": {
            subject: "Protect South Carolina’s State Forests – Our Future Depends on It",
            body: `Dear [Representative’s Name],

As a South Carolinian, I take great pride in our beautiful forests, parks, and public lands... [truncated for brevity]`
        },
        "state_led_approach": {
            subject: "Support South Carolina’s Forests – Oppose Harmful Federal Policies",
            body: `Dear [Representative’s Name],

I am writing to express my strong support for preserving and protecting South Carolina’s state forests... [truncated for brevity]`
        }
    };
